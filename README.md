...
[![engine: @attestwire/en16931 0.11.0](https://img.shields.io/badge/engine-%40attestwire%2Fen16931%400.11.0-blue)](https://www.npmjs.com/package/@attestwire/en16931)
...
>
> Mode: **local** · Rules: bundled `@attestwire/en16931@0.11.0` — pinned, offline, no key · Fails on: `error`
>
...
- **Local mode (default)** — `@attestwire/en16931@0.11.0` is bundled into
